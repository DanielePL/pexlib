// client/src/services/sportsTaxonomyService.js
...
export const getSportById = (id) => sportsTaxonomy.find(sport => sport.id === id);

export const getAllSports = () => sportsTaxonomy;

export const getSportKeywords = (sportId) => {
